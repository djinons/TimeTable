...
public class FridayFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View viewFriday = inflater.inflate(R.layout.fragment_for_one_day, container, false);

        recyclerView = viewFriday.findViewById(R.id.one_day_recycler_view);
        dayTV = viewFriday.findViewById(R.id.day_name_one_frag_TV);
        ...
        Cursor mondayClass = myDb.getDataForDay("Dunja","FRIDAY");
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        dayTV.setText(getString(R.string.friday));
